								...
								<div class="tab-content mu-schedule-content">
								    <div role="tabpanel" class="tab-pane fade mu-event-timeline in active" id="first-day">
								    	<ul>
								    		...
								    		<li>
								    			<div class="mu-single-event">
								    				<img src="<?= base_url();?>/assets/images/speaker-1.jpg" alt="event speaker">
								    		...
								    		<li>
								    			<div class="mu-single-event">
								    				<img src="<?= base_url();?>/assets/images/speaker-2.jpg" alt="event speaker">
								    		...
								    		<li>
								    			<div class="mu-single-event">
								    				<img src="<?= base_url();?>/assets/images/speaker-3.jpg" alt="event speaker">
						...
						<div class="mu-speakers-area">
							...
							<div class="mu-speakers-content">
								...
								<div class="mu-speakers-slider">
									...
									<!-- Start single speaker -->
									<div class="mu-single-speakers">
										<img src="<?= base_url();?>/assets/images/speaker-2.jpg" alt="speaker img">
										<div class="mu-single-speakers-info">
									...
									<!-- Start single speaker -->
									<div class="mu-single-speakers">
										<img src="<?= base_url();?>/assets/images/speaker-3.jpg" alt="speaker img">
										<div class="mu-single-speakers-info">
											<h3>Ned Stark</h3>
									...
									<!-- Start single speaker -->
									<div class="mu-single-speakers">
										<img src="<?= base_url();?>/assets/images/speaker-4.jpg" alt="speaker img">
										<div class="mu-single-speakers-info">
											<h3>Michaela Lehr </h3>
						...
						<div class="mu-sponsors-area">
							...
							<div class="mu-sponsors-content">
								<div class="row">
									...
									<div class="col-md-2 col-sm-4 col-xs-4">
										<div class="mu-sponsors-single">
											<img src="<?= base_url();?>/assets/images/sponsor-logo-7.png" alt="Brand Logo">
										</div>
									</div>

									<div class="col-md-2 col-sm-4 col-xs-4">
										<div class="mu-sponsors-single">
											<img src="<?= base_url();?>/assets/images/sponsor-logo-8.png" alt="Brand Logo">
										</div>
									</div>

									<div class="col-md-2 col-sm-4 col-xs-4">
										<div class="mu-sponsors-single">
											<img src="<?= base_url();?>/assets/images/sponsor-logo-9.png" alt="Brand Logo">
										</div>
									</div>
